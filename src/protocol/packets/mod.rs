...
use crate::protocol::packets::handshake::EnumProtocol;
...
impl PacketRegistry {
    pub fn new() -> Self {
        let mut handlers: HashMap<PacketKey, DecoderFn> = HashMap::with_capacity(24); // TODO: add 1 for every new packets
